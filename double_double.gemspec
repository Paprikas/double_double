...
Gem::Specification.new do |gem|
  ...
  gem.description = "A double-entry accural accounting system"
  gem.summary = "A double-entry accural accounting system. All currency amounts are stored using the Money gem."
