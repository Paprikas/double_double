...
shared_examples "a normal credit account type" do
  describe "<<" do
    describe "basic behavior" do
      before(:each) do
        @acct1 = FactoryBot.create(normal_credit_account_type, name: "acct1")
        @acct2_contra = FactoryBot.create(normal_credit_account_type, name: "acct2_contra", contra: true)
        @other_account = FactoryBot.create("not_#{normal_credit_account_type}".to_sym, name: "other_account")
      end
    ...
    describe "context" do
      it "should return the balance with respect to context is supplied" do
        acct1 = FactoryBot.create(normal_credit_account_type, name: "acct1")
        acct2 = FactoryBot.create(normal_credit_account_type, name: "acct2")
        other_account = FactoryBot.create("not_#{normal_credit_account_type}".to_sym, name: "other_account")
        a1 = rand(1_000_000_000)
        a2 = rand(1_000_000_000)
        a3 = rand(1_000_000_000)
        a4 = rand(1_000_000_000)
        @project1 = FactoryBot.create(normal_credit_account_type)
        @invoice555 = FactoryBot.create(normal_credit_account_type)
